...
namespace mixer::config
{
    ...
    inline constexpr uint32_t kSamplePeriodMs = 100; // 10 раз в секунду. Может 80 sps попробовать потом
    inline constexpr uint32_t kHx711ReadyTimeoutMs = 120;
    inline constexpr uint32_t kHx711DiagnosticLogPeriodMs = 1000;
    inline constexpr bool kHx711ReadReadySubsetForDiagnostics = true;
    ...
    inline constexpr float kHub75SpinnerSpeedRpm = 60.0f;
