...
- Формат UDP CSV держи централизованно в `docs/04-udp-csv-contract.md`. При изменении `scale_id,seq,ms,rawN,raw_sum,kg_sum,flags` сначала обновляй этот контракт, затем прошивку, приемник и анализаторы.
