    ...
    IReadOnlyList<string> ExtraFields)
{
    ...
    public static bool TryParse(string line, out SensorCsvPacket packet, out string error)
    {
        ...
        packet = new SensorCsvPacket(scaleId, sequence, espMilliseconds, rawSum, kilogramsSum, parts[flagsIndex], extraFields);
        return true;
    }

    public string BuildHeader()
    {
        IEnumerable<string> baseHeaders = new[] { "scale_id", "seq", "ms", "raw_sum", "kg_sum", "flags" };
    ...
    {
        IEnumerable<string> baseParts = new[]
        {
